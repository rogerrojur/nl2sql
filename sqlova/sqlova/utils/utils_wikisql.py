...
def pred_wvi_se(wn, s_wv1, s_wv2, s_wv3, s_wv4, s_pick, mvl):
    """
    s_pick: [B, 4, 2]
    - predict best st-idx & ed-idx
    """
    pr_pick = s_pick.argmax(dim=2)#[B, 4, 2] -> [B, 4]
...
def pred_sw_se(s_sn, s_sc, s_sa, s_wn, s_wr, s_hrpc, s_wrpc, s_nrpc, s_wc, s_wo, s_wv1, s_wv2, s_wv3, s_wv4, s_pick, mvl):
    pr_sn = pred_sn(s_sn)
    ...
    pr_wvi = pred_wvi_se(pr_wn, s_wv1, s_wv2, s_wv3, s_wv4, s_pick, mvl)
