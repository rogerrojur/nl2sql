...
if __name__ == '__main__':
    ...
    path_save_for_evaluation = '../submit'
    ...
    # )
    ## 4. Build & Load models
    model, model_bert, tokenizer, bert_config = get_models(args, BERT_PT_PATH, trained=True, path_model_bert='../model/model_bert_best.pt', path_model='../model/model_best.pt')
