...
def annotate(sentence, lower=True):
    global client
    if client is None:
        client = CoreNLPClient(server='http://127.0.0.1:20000', default_annotators='ssplit,tokenize'.split(','))
    words, gloss, after = [], [], []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--din', default='wikisql\data', help='data directory')
    parser.add_argument('--dout', default='wikisql\data\wikisql_tok', help='output directory')
